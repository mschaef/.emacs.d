...
this mode runs the hook `clojure-mode-hook', as the final or
...
In addition to any hooks its parent mode `clojure-mode' might have
run, this mode runs the hook `clojurescript-mode-hook', as the final
...
In addition to any hooks its parent mode `clojure-mode' might have
run, this mode runs the hook `clojurec-mode-hook', as the final or
penultimate step during initialization." t)
...
In addition to any hooks its parent mode `clojure-mode' might have
run, this mode runs the hook `clojuredart-mode-hook', as the final or
penultimate step during initialization." t)
...
In addition to any hooks its parent mode `clojure-mode' might have
run, this mode runs the hook `jank-mode-hook', as the final or
penultimate step during initialization." t)
...
In addition to any hooks its parent mode `clojure-mode' might have
run, this mode runs the hook `joker-mode-hook', as the final or
penultimate step during initialization." t)
...
In addition to any hooks its parent mode `clojure-mode' might have
run, this mode runs the hook `edn-mode-hook', as the final or
penultimate step during initialization." t)
